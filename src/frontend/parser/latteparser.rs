    ...
    Actions<'input, BaseParserType<'input, I>> for LatteParserExt<'input>
{
    ...
    fn sempred(
        ...
        match rule_index {
            9 => LatteParser::<'input, I, _>::type__sempred(
                _localctx.and_then(|x| x.downcast_ref()),
                pred_index,
                recog,
            ),
            11 => LatteParser::<'input, I, _>::expr_sempred(
                _localctx.and_then(|x| x.downcast_ref()),
                pred_index,
                recog,
            ),
    ...
    I: TokenStream<'input, TF = LocalTokenFactory<'input>> + TidAble<'input>,
{
    ...
    fn expr_sempred(
        ...
        match pred_index {
            1 => recog.precpred(None, 16),
            2 => recog.precpred(None, 15),
            3 => recog.precpred(None, 14),
            4 => recog.precpred(None, 13),
            5 => recog.precpred(None, 12),
            6 => recog.precpred(None, 3),
            7 => recog.precpred(None, 2),
            8 => recog.precpred(None, 1),
            _ => true,
        }
    }
}
...
impl<'input> StrContextExt<'input> {
    fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>> {
        Rc::new(Type_ContextAll::StrContext(
            BaseParserRuleContext::copy_from(
                ctx,
                StrContextExt {
                    base: ctx.borrow().clone(),
...
impl<'input> ArrContextExt<'input> {
    fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>> {
        Rc::new(Type_ContextAll::ArrContext(
            BaseParserRuleContext::copy_from(
                ctx,
                ArrContextExt {
                    base: ctx.borrow().clone(),
...
impl<'input> BoolContextExt<'input> {
    fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>> {
        Rc::new(Type_ContextAll::BoolContext(
            BaseParserRuleContext::copy_from(
                ctx,
                BoolContextExt {
                    base: ctx.borrow().clone(),
...
impl<'input> ClassContextExt<'input> {
    fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>> {
        Rc::new(Type_ContextAll::ClassContext(
            BaseParserRuleContext::copy_from(
                ctx,
                ClassContextExt {
                    base: ctx.borrow().clone(),
...
impl<'input> IntContextExt<'input> {
    fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>> {
        Rc::new(Type_ContextAll::IntContext(
            BaseParserRuleContext::copy_from(
                ctx,
                IntContextExt {
                    base: ctx.borrow().clone(),
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    ...
    fn type__rec(&mut self, _p: isize) -> Result<Rc<Type_ContextAll<'input>>, ANTLRError> {
        let recog = self;
        let _parentctx = recog.ctx.take();
        ...
        recog
            .base
            .enter_recursion_rule(_localctx.clone(), 18, RULE_type_, _p);
                        ...
                        {
                            {
                                ...
                                let mut tmp = ArrContextExt::new(&**Type_ContextExt::new(
                                    _parentctx.clone(),
                                    _parentState,
                                ));
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    ...
    fn expr_rec(&mut self, _p: isize) -> Result<Rc<ExprContextAll<'input>>, ANTLRError> {
        ...
        recog
            .base
            .enter_recursion_rule(_localctx.clone(), 22, RULE_expr, _p);
