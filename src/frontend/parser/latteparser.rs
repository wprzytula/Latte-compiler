...
use std::any::{Any,TypeId};
	...
	pub const ruleNames: [&'static str; 22] =  [
		"program", "topDef", "funDef", "params", "param", "classBlock", "classItem", 
		"decl", "items", "item", "block", "stmt", "lval", "type_", "nonvoid_type", 
		"newtype", "expr", "args", "arg", "addOp", "mulOp", "relOp"
	];
...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for LatteParserExt<'input>{
	...
	fn sempred(_localctx: Option<&(dyn LatteParserContext<'input> + 'input)>, rule_index: isize, pred_index: isize,
		...
		match rule_index {
					12 => LatteParser::<'input,I,_>::lval_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					16 => LatteParser::<'input,I,_>::expr_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
			_ => true
		}
	}
}
	...
	-> Result<Rc<ProgramContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			loop {
				...
				recog.err_handler.sync(&mut recog.base)?;
				_la = recog.base.input.la(1);
				if !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << T__0) | (1usize << T__20) | (1usize << T__21) | (1usize << T__23) | (1usize << T__24))) != 0) || _la==ID) {break}
			}
			}
			Ok(())
		})();
...
impl<'input> TopFnDefContextExt<'input>{
	fn new(ctx: &dyn TopDefContextAttrs<'input>) -> Rc<TopDefContextAll<'input>>  {
		Rc::new(
			TopDefContextAll::TopFnDefContext(
				BaseParserRuleContext::copy_from(ctx,TopFnDefContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
fn params(&self) -> Option<Rc<ParamsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
impl<'input> ParamsContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ParamsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ParamsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ParamsContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ParamsContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ParamsContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> ParamContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ParamContextAll<'input>> {
		Rc::new(
...
pub trait ParamContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ParamContextExt<'input>>{

fn nonvoid_type(&self) -> Option<Rc<Nonvoid_typeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token ID
/// Returns `None` if there is no child corresponding to token ID
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ClassBlockContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 10, RULE_classBlock);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while ((((_la - 21)) & !0x3f) == 0 && ((1usize << (_la - 21)) & ((1usize << (T__20 - 21)) | (1usize << (T__21 - 21)) | (1usize << (T__23 - 21)) | (1usize << (T__24 - 21)) | (1usize << (ID - 21)))) != 0) {
				{
				{
...
fn items(&self) -> Option<Rc<ItemsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
impl<'input> CustomRuleContext<'input> for ItemsContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_items }
	//fn type_rule_index() -> usize where Self: Sized { RULE_items }
}
antlr_rust::tid!{ItemsContextExt<'a>}

impl<'input> ItemsContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ItemsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ItemsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ItemsContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ItemsContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ItemsContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type DeclItemUninitContext<'input> = BaseParserRuleContext<'input,DeclItemUninitContextExt<'input>>;
...
impl<'input> Borrow<ItemContextExt<'input>> for DeclItemUninitContext<'input>{
	fn borrow(&self) -> &ItemContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<ItemContextExt<'input>> for DeclItemUninitContext<'input>{
	fn borrow_mut(&mut self) -> &mut ItemContextExt<'input> { &mut self.base }
}
...
impl<'input> DeclItemUninitContextExt<'input>{
	fn new(ctx: &dyn ItemContextAttrs<'input>) -> Rc<ItemContextAll<'input>>  {
		Rc::new(
			ItemContextAll::DeclItemUninitContext(
				BaseParserRuleContext::copy_from(ctx,DeclItemUninitContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
pub type DeclItemInitContext<'input> = BaseParserRuleContext<'input,DeclItemInitContextExt<'input>>;
...
impl<'input> DeclItemInitContextExt<'input>{
	fn new(ctx: &dyn ItemContextAttrs<'input>) -> Rc<ItemContextAll<'input>>  {
		Rc::new(
			ItemContextAll::DeclItemInitContext(
				BaseParserRuleContext::copy_from(ctx,DeclItemInitContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<BlockContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << T__2) | (1usize << T__5) | (1usize << T__7) | (1usize << T__11) | (1usize << T__12) | (1usize << T__14) | (1usize << T__15) | (1usize << T__21) | (1usize << T__23) | (1usize << T__24) | (1usize << T__25) | (1usize << T__26) | (1usize << T__29) | (1usize << T__30))) != 0) || ((((_la - 33)) & !0x3f) == 0 && ((1usize << (_la - 33)) & ((1usize << (T__32 - 33)) | (1usize << (INT - 33)) | (1usize << (ID - 33)) | (1usize << (STR - 33)))) != 0) {
				{
				{
				/*InvokeRule stmt*/
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<LvalContextAll<'input>>,ANTLRError> {
		...
		recog.base.enter_recursion_rule(_localctx.clone(), 24, RULE_lval, _p);
...
impl<'input> NonvoidContextExt<'input>{
	fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>>  {
		Rc::new(
			Type_ContextAll::NonvoidContext(
				BaseParserRuleContext::copy_from(ctx,NonvoidContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
pub type Nonvoid_typeContext<'input> = BaseParserRuleContext<'input,Nonvoid_typeContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Nonvoid_typeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_nonvoid_type }
...
impl<'input> Nonvoid_typeContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Nonvoid_typeContextAll<'input>> {
		Rc::new(
		Nonvoid_typeContextAll::Error(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Nonvoid_typeContextExt{
				ph:PhantomData
			}),
		)
		)
...
pub trait Nonvoid_typeContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<Nonvoid_typeContextExt<'input>>{
...
impl<'input> Borrow<Nonvoid_typeContextExt<'input>> for StrContext<'input>{
	fn borrow(&self) -> &Nonvoid_typeContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Nonvoid_typeContextExt<'input>> for StrContext<'input>{
	fn borrow_mut(&mut self) -> &mut Nonvoid_typeContextExt<'input> { &mut self.base }
}
...
impl<'input> StrContextExt<'input>{
	fn new(ctx: &dyn Nonvoid_typeContextAttrs<'input>) -> Rc<Nonvoid_typeContextAll<'input>>  {
		Rc::new(
			Nonvoid_typeContextAll::StrContext(
...
impl<'input> BoolContextExt<'input>{
	fn new(ctx: &dyn Nonvoid_typeContextAttrs<'input>) -> Rc<Nonvoid_typeContextAll<'input>>  {
		Rc::new(
			Nonvoid_typeContextAll::BoolContext(
...
impl<'input> ClassArrContextExt<'input>{
	fn new(ctx: &dyn Nonvoid_typeContextAttrs<'input>) -> Rc<Nonvoid_typeContextAll<'input>>  {
		Rc::new(
			Nonvoid_typeContextAll::ClassArrContext(
				BaseParserRuleContext::copy_from(ctx,ClassArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> IntArrContextExt<'input>{
	fn new(ctx: &dyn Nonvoid_typeContextAttrs<'input>) -> Rc<Nonvoid_typeContextAll<'input>>  {
		Rc::new(
			Nonvoid_typeContextAll::IntArrContext(
				BaseParserRuleContext::copy_from(ctx,IntArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> StrArrContextExt<'input>{
	fn new(ctx: &dyn Nonvoid_typeContextAttrs<'input>) -> Rc<Nonvoid_typeContextAll<'input>>  {
		Rc::new(
			Nonvoid_typeContextAll::StrArrContext(
				BaseParserRuleContext::copy_from(ctx,StrArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> ClassContextExt<'input>{
	fn new(ctx: &dyn Nonvoid_typeContextAttrs<'input>) -> Rc<Nonvoid_typeContextAll<'input>>  {
		Rc::new(
			Nonvoid_typeContextAll::ClassContext(
...
impl<'input> BooleanArrContextExt<'input>{
	fn new(ctx: &dyn Nonvoid_typeContextAttrs<'input>) -> Rc<Nonvoid_typeContextAll<'input>>  {
		Rc::new(
			Nonvoid_typeContextAll::BooleanArrContext(
				BaseParserRuleContext::copy_from(ctx,BooleanArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> IntContextExt<'input>{
	fn new(ctx: &dyn Nonvoid_typeContextAttrs<'input>) -> Rc<Nonvoid_typeContextAll<'input>>  {
		Rc::new(
			Nonvoid_typeContextAll::IntContext(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Nonvoid_typeContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 28, RULE_nonvoid_type);
...
impl<'input> CustomRuleContext<'input> for NewtypeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_newtype }
...
impl<'input> NewtypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<NewtypeContextAll<'input>> {
		Rc::new(
		NewtypeContextAll::Error(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,NewtypeContextExt{
				ph:PhantomData
			}),
		)
		)
...
pub trait NewtypeContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<NewtypeContextExt<'input>>{
...
impl<'input> Borrow<NewtypeContextExt<'input>> for NStrArrContext<'input>{
	fn borrow(&self) -> &NewtypeContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<NewtypeContextExt<'input>> for NStrArrContext<'input>{
	fn borrow_mut(&mut self) -> &mut NewtypeContextExt<'input> { &mut self.base }
}
...
impl<'input> NStrArrContextExt<'input>{
	fn new(ctx: &dyn NewtypeContextAttrs<'input>) -> Rc<NewtypeContextAll<'input>>  {
		Rc::new(
			NewtypeContextAll::NStrArrContext(
				BaseParserRuleContext::copy_from(ctx,NStrArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> NBoolContextExt<'input>{
	fn new(ctx: &dyn NewtypeContextAttrs<'input>) -> Rc<NewtypeContextAll<'input>>  {
		Rc::new(
			NewtypeContextAll::NBoolContext(
...
impl<'input> NClassContextExt<'input>{
	fn new(ctx: &dyn NewtypeContextAttrs<'input>) -> Rc<NewtypeContextAll<'input>>  {
		Rc::new(
			NewtypeContextAll::NClassContext(
...
impl<'input> NBooleanArrContextExt<'input>{
	fn new(ctx: &dyn NewtypeContextAttrs<'input>) -> Rc<NewtypeContextAll<'input>>  {
		Rc::new(
			NewtypeContextAll::NBooleanArrContext(
				BaseParserRuleContext::copy_from(ctx,NBooleanArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> NIntArrContextExt<'input>{
	fn new(ctx: &dyn NewtypeContextAttrs<'input>) -> Rc<NewtypeContextAll<'input>>  {
		Rc::new(
			NewtypeContextAll::NIntArrContext(
				BaseParserRuleContext::copy_from(ctx,NIntArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> NClassArrContextExt<'input>{
	fn new(ctx: &dyn NewtypeContextAttrs<'input>) -> Rc<NewtypeContextAll<'input>>  {
		Rc::new(
			NewtypeContextAll::NClassArrContext(
				BaseParserRuleContext::copy_from(ctx,NClassArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn newtype(&mut self,)
	-> Result<Rc<NewtypeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait ENewContextAttrs<'input>: LatteParserContext<'input>{
	fn newtype(&self) -> Option<Rc<NewtypeContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
}
...
impl<'input> ArgsContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ArgsContextAll<'input>> {
		Rc::new(
...
pub trait ArgsContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ArgsContextExt<'input>>{
...
const _serializedATN:&'static str =
	...
	\x33\u{147}\x04\x02\x09\x02\x04\x03\x09\x03\x04\x04\x09\x04\x04\x05\x09\
	...
	\x0c\x07\x0e\x07\x59\x0b\x07\x03\x07\x03\x07\x03\x08\x03\x08\x03\x08\x03\
	\x08\x05\x08\x61\x0a\x08\x03\x09\x03\x09\x03\x09\x03\x09\x03\x0a\x03\x0a\
	\x03\x0a\x07\x0a\x6a\x0a\x0a\x0c\x0a\x0e\x0a\x6d\x0b\x0a\x03\x0b\x03\x0b\
	\x03\x0b\x03\x0b\x05\x0b\x73\x0a\x0b\x03\x0c\x03\x0c\x07\x0c\x77\x0a\x0c\
	\x0c\x0c\x0e\x0c\x7a\x0b\x0c\x03\x0c\x03\x0c\x03\x0d\x03\x0d\x03\x0d\x03\
	\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\
	\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\
	\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\
	\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\
	\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\
	\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x05\x0d\u{b4}\x0a\x0d\x03\x0e\
	\x03\x0e\x03\x0e\x03\x0e\x03\x0e\x03\x0e\x03\x0e\x03\x0e\x03\x0e\x03\x0e\
	\x03\x0e\x07\x0e\u{c1}\x0a\x0e\x0c\x0e\x0e\x0e\u{c4}\x0b\x0e\x03\x0f\x03\
	\x0f\x05\x0f\u{c8}\x0a\x0f\x03\x10\x03\x10\x03\x10\x03\x10\x03\x10\x03\x10\
	\x03\x10\x03\x10\x03\x10\x03\x10\x03\x10\x03\x10\x05\x10\u{d6}\x0a\x10\x03\
	\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\
	\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\
	\x11\x03\x11\x03\x11\x03\x11\x03\x11\x03\x11\x05\x11\u{f0}\x0a\x11\x03\x12\
	\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\
	\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\
	\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x05\x12\u{10a}\x0a\x12\x03\x12\
	\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\
	\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\
	\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\
	\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\x07\x12\u{12d}\x0a\x12\x0c\x12\
	\x0e\x12\u{130}\x0b\x12\x03\x13\x03\x13\x03\x13\x07\x13\u{135}\x0a\x13\x0c\
	\x13\x0e\x13\u{138}\x0b\x13\x05\x13\u{13a}\x0a\x13\x03\x13\x05\x13\u{13d}\
	\x0a\x13\x03\x14\x03\x14\x03\x15\x03\x15\x03\x16\x03\x16\x03\x17\x03\x17\
	\x03\x17\x02\x04\x1a\x22\x18\x02\x04\x06\x08\x0a\x0c\x0e\x10\x12\x14\x16\
	\x18\x1a\x1c\x1e\x20\x22\x24\x26\x28\x2a\x2c\x02\x06\x03\x02\x1c\x1d\x04\
	\x02\x1c\x1c\x24\x24\x03\x02\x25\x27\x03\x02\x28\x2d\x02\u{16b}\x02\x2f\
	\x03\x02\x02\x02\x04\x3c\x03\x02\x02\x02\x06\x3e\x03\x02\x02\x02\x08\x4e\
	\x03\x02\x02\x02\x0a\x50\x03\x02\x02\x02\x0c\x53\x03\x02\x02\x02\x0e\x60\
	\x03\x02\x02\x02\x10\x62\x03\x02\x02\x02\x12\x66\x03\x02\x02\x02\x14\x72\
