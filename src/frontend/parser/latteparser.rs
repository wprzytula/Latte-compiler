...
use std::any::{Any,TypeId};
	...
	pub const RULE_arg:usize = 3; 
	pub const RULE_classBlock:usize = 4; 
	pub const RULE_classItem:usize = 5; 
	pub const RULE_decl:usize = 6; 
	pub const RULE_block:usize = 7; 
	pub const RULE_stmt:usize = 8; 
	pub const RULE_lval:usize = 9; 
	pub const RULE_type_:usize = 10; 
	pub const RULE_newtype_:usize = 11; 
	pub const RULE_item:usize = 12; 
	pub const RULE_expr:usize = 13; 
	pub const RULE_addOp:usize = 14; 
	pub const RULE_mulOp:usize = 15; 
	pub const RULE_relOp:usize = 16;
	pub const ruleNames: [&'static str; 17] =  [
		"program", "topDef", "funDef", "arg", "classBlock", "classItem", "decl", 
		"block", "stmt", "lval", "type_", "newtype_", "item", "expr", "addOp", 
		"mulOp", "relOp"
	];
	...
	pub const _LITERAL_NAMES: [Option<&'static str>;44] = [
		...
		Some("':'"), Some("'.'"), Some("'['"), Some("']'"), Some("'int'"), Some("'string'"), 
		Some("'boolean'"), Some("'void'"), Some("'[]'"), Some("'-'"), Some("'!'"), 
...
type BaseParserType<'input, I> =
	BaseParser<'input,LatteParserExt<'input>, I, LatteParserContextType , dyn LatteListener<'input> + 'input >;
...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> ParserRecog<'input, BaseParserType<'input,I>> for LatteParserExt<'input>{}

impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for LatteParserExt<'input>{
	fn get_grammar_file_name(&self) -> & str{ "Latte.g4"}

   	fn get_rule_names(&self) -> &[& str] {&ruleNames}

   	fn get_vocabulary(&self) -> &dyn Vocabulary { &**VOCABULARY }
	fn sempred(_localctx: Option<&(dyn LatteParserContext<'input> + 'input)>, rule_index: isize, pred_index: isize,
			   recog:&mut BaseParserType<'input,I>
	)->bool{
		match rule_index {
					9 => LatteParser::<'input,I,_>::lval_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					10 => LatteParser::<'input,I,_>::type__sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					13 => LatteParser::<'input,I,_>::expr_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
			_ => true
		}
	}
}
...
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
{
	fn lval_sempred(_localctx: Option<&LvalContext<'input>>, pred_index:isize,
	...
	fn type__sempred(_localctx: Option<&Type_Context<'input>>, pred_index:isize,
						recog:&mut <Self as Deref>::Target
		) -> bool {
		match pred_index {
				2=>{
...
impl<'input> ProgramContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ProgramContextAll<'input>> {
		Rc::new(
...
pub trait ProgramContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ProgramContextExt<'input>>{

fn topDef_all(&self) ->  Vec<Rc<TopDefContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn topDef(&self, i: usize) -> Option<Rc<TopDefContextAll<'input>>> where Self:Sized{
	...
	-> Result<Rc<ProgramContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			loop {
				...
				recog.err_handler.sync(&mut recog.base)?;
				_la = recog.base.input.la(1);
				if !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << T__0) | (1usize << T__20) | (1usize << T__21) | (1usize << T__22) | (1usize << T__23))) != 0) || _la==ID) {break}
			}
			}
			Ok(())
		})();
...
pub enum TopDefContextAll<'input>{
	FnDefContext(FnDefContext<'input>),
...
impl<'input,'a> Visitable<dyn LatteVisitor<'input> + 'a> for TopDefContextAll<'input>{
	fn accept(&self, visitor: &mut (dyn LatteVisitor<'input> + 'a)) { self.deref().accept(visitor) }
}
impl<'input,'a> Listenable<dyn LatteListener<'input> + 'a> for TopDefContextAll<'input>{
    fn enter(&self, listener: &mut (dyn LatteListener<'input> + 'a)) { self.deref().enter(listener) }
    fn exit(&self, listener: &mut (dyn LatteListener<'input> + 'a)) { self.deref().exit(listener) }
}
...
impl<'input> CustomRuleContext<'input> for TopDefContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_topDef }
	//fn type_rule_index() -> usize where Self: Sized { RULE_topDef }
}
antlr_rust::tid!{TopDefContextExt<'a>}

impl<'input> TopDefContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TopDefContextAll<'input>> {
		Rc::new(
		TopDefContextAll::Error(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TopDefContextExt{
				ph:PhantomData
			}),
		)
		)
...
pub trait TopDefContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<TopDefContextExt<'input>>{
...
pub type FnDefContext<'input> = BaseParserRuleContext<'input,FnDefContextExt<'input>>;

pub trait FnDefContextAttrs<'input>: LatteParserContext<'input>{
	fn funDef(&self) -> Option<Rc<FunDefContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
}

impl<'input> FnDefContextAttrs<'input> for FnDefContext<'input>{}

pub struct FnDefContextExt<'input>{
	base:TopDefContextExt<'input>,
	ph:PhantomData<&'input str>
}

antlr_rust::tid!{FnDefContextExt<'a>}

impl<'input> LatteParserContext<'input> for FnDefContext<'input>{}

impl<'input,'a> Listenable<dyn LatteListener<'input> + 'a> for FnDefContext<'input>{
	fn enter(&self,listener: &mut (dyn LatteListener<'input> + 'a)) {
		listener.enter_every_rule(self);
		listener.enter_FnDef(self);
	}
	fn exit(&self,listener: &mut (dyn LatteListener<'input> + 'a)) {
		listener.exit_FnDef(self);
		listener.exit_every_rule(self);
	}
}

impl<'input,'a> Visitable<dyn LatteVisitor<'input> + 'a> for FnDefContext<'input>{
	fn accept(&self,visitor: &mut (dyn LatteVisitor<'input> + 'a)) {
		visitor.visit_FnDef(self);
	}
}

impl<'input> CustomRuleContext<'input> for FnDefContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_topDef }
	//fn type_rule_index() -> usize where Self: Sized { RULE_topDef }
...
impl<'input> Borrow<TopDefContextExt<'input>> for FnDefContext<'input>{
	fn borrow(&self) -> &TopDefContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<TopDefContextExt<'input>> for FnDefContext<'input>{
	fn borrow_mut(&mut self) -> &mut TopDefContextExt<'input> { &mut self.base }
}

impl<'input> TopDefContextAttrs<'input> for FnDefContext<'input> {}

impl<'input> FnDefContextExt<'input>{
	fn new(ctx: &dyn TopDefContextAttrs<'input>) -> Rc<TopDefContextAll<'input>>  {
		Rc::new(
			TopDefContextAll::FnDefContext(
				BaseParserRuleContext::copy_from(ctx,FnDefContextExt{
...
pub trait DerivClsContextAttrs<'input>: LatteParserContext<'input>{
	...
	fn ID_all(&self) -> Vec<Rc<TerminalNode<'input,LatteParserContextType>>>  where Self:Sized{
		self.children_of_type()
	}
	...
	fn ID(&self, i: usize) -> Option<Rc<TerminalNode<'input,LatteParserContextType>>> where Self:Sized{
		self.get_token(ID, i)
	}
	fn classBlock(&self) -> Option<Rc<ClassBlockContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
}
...
impl<'input> DerivClsContextExt<'input>{
	fn new(ctx: &dyn TopDefContextAttrs<'input>) -> Rc<TopDefContextAll<'input>>  {
		Rc::new(
			TopDefContextAll::DerivClsContext(
				BaseParserRuleContext::copy_from(ctx,DerivClsContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
pub trait BaseClsContextAttrs<'input>: LatteParserContext<'input>{
	...
	fn ID(&self) -> Option<Rc<TerminalNode<'input,LatteParserContextType>>> where Self:Sized{
		self.get_token(ID, 0)
	}
	fn classBlock(&self) -> Option<Rc<ClassBlockContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
...
impl<'input> BaseClsContextExt<'input>{
	fn new(ctx: &dyn TopDefContextAttrs<'input>) -> Rc<TopDefContextAll<'input>>  {
		Rc::new(
			TopDefContextAll::BaseClsContext(
				BaseParserRuleContext::copy_from(ctx,BaseClsContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn topDef(&mut self,)
	-> Result<Rc<TopDefContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			match  recog.interpreter.adaptive_predict(1,&mut recog.base)? {
				1 =>{
					let tmp = FnDefContextExt::new(&**_localctx);
...
impl<'input> CustomRuleContext<'input> for FunDefContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_funDef }
	//fn type_rule_index() -> usize where Self: Sized { RULE_funDef }
}
antlr_rust::tid!{FunDefContextExt<'a>}

impl<'input> FunDefContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FunDefContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FunDefContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait FunDefContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<FunDefContextExt<'input>>{
...
fn arg(&self) -> Option<Rc<ArgContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn funDef(&mut self,)
	-> Result<Rc<FunDefContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			if ((((_la - 21)) & !0x3f) == 0 && ((1usize << (_la - 21)) & ((1usize << (T__20 - 21)) | (1usize << (T__21 - 21)) | (1usize << (T__22 - 21)) | (1usize << (T__23 - 21)) | (1usize << (ID - 21)))) != 0) {
				{
				/*InvokeRule arg*/
...
impl<'input> ArgContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ArgContextAll<'input>> {
		Rc::new(
...
pub trait ArgContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ArgContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ArgContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 6, RULE_arg);
...
impl<'input> CustomRuleContext<'input> for ClassBlockContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_classBlock }
...
impl<'input> ClassBlockContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ClassBlockContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ClassBlockContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ClassBlockContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ClassBlockContextExt<'input>>{

fn classItem_all(&self) ->  Vec<Rc<ClassItemContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn classItem(&self, i: usize) -> Option<Rc<ClassItemContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn classBlock(&mut self,)
	-> Result<Rc<ClassBlockContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ClassBlockContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 8, RULE_classBlock);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while ((((_la - 21)) & !0x3f) == 0 && ((1usize << (_la - 21)) & ((1usize << (T__20 - 21)) | (1usize << (T__21 - 21)) | (1usize << (T__22 - 21)) | (1usize << (T__23 - 21)) | (1usize << (ID - 21)))) != 0) {
				{
				{
...
impl<'input> CustomRuleContext<'input> for ClassItemContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_classItem }
...
impl<'input> ClassItemContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ClassItemContextAll<'input>> {
		Rc::new(
		ClassItemContextAll::Error(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ClassItemContextExt{
				ph:PhantomData
			}),
		)
		)
...
pub trait ClassItemContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ClassItemContextExt<'input>>{
...
impl<'input> Borrow<ClassItemContextExt<'input>> for FieldContext<'input>{
	fn borrow(&self) -> &ClassItemContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<ClassItemContextExt<'input>> for FieldContext<'input>{
	fn borrow_mut(&mut self) -> &mut ClassItemContextExt<'input> { &mut self.base }
}
...
impl<'input> FieldContextExt<'input>{
	fn new(ctx: &dyn ClassItemContextAttrs<'input>) -> Rc<ClassItemContextAll<'input>>  {
		Rc::new(
			ClassItemContextAll::FieldContext(
				BaseParserRuleContext::copy_from(ctx,FieldContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> MethodContextExt<'input>{
	fn new(ctx: &dyn ClassItemContextAttrs<'input>) -> Rc<ClassItemContextAll<'input>>  {
		Rc::new(
			ClassItemContextAll::MethodContext(
				BaseParserRuleContext::copy_from(ctx,MethodContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn classItem(&mut self,)
	-> Result<Rc<ClassItemContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ClassItemContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 10, RULE_classItem);
...
impl<'input> DeclContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DeclContextAll<'input>> {
		Rc::new(
...
pub trait DeclContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<DeclContextExt<'input>>{

fn type_(&self) -> Option<Rc<Type_ContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn item_all(&self) ->  Vec<Rc<ItemContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn item(&self, i: usize) -> Option<Rc<ItemContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
impl<'input> BlockContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BlockContextAll<'input>> {
		Rc::new(
...
pub trait BlockContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<BlockContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<BlockContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << T__2) | (1usize << T__5) | (1usize << T__7) | (1usize << T__11) | (1usize << T__12) | (1usize << T__14) | (1usize << T__15) | (1usize << T__20) | (1usize << T__21) | (1usize << T__22) | (1usize << T__23) | (1usize << T__25) | (1usize << T__26) | (1usize << T__29) | (1usize << T__30))) != 0) || ((((_la - 33)) & !0x3f) == 0 && ((1usize << (_la - 33)) & ((1usize << (T__32 - 33)) | (1usize << (INT - 33)) | (1usize << (ID - 33)) | (1usize << (STR - 33)))) != 0) {
				{
				{
				/*InvokeRule stmt*/
...
impl<'input> StmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StmtContextAll<'input>> {
		Rc::new(
...
pub trait StmtContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<StmtContextExt<'input>>{
...
pub trait AssContextAttrs<'input>: LatteParserContext<'input>{
	fn lval(&self) -> Option<Rc<LvalContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
...
impl<'input> AssContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::AssContext(
				BaseParserRuleContext::copy_from(ctx,AssContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> RetContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::RetContext(
				BaseParserRuleContext::copy_from(ctx,RetContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> CondContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::CondContext(
				BaseParserRuleContext::copy_from(ctx,CondContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> CondElseContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::CondElseContext(
				BaseParserRuleContext::copy_from(ctx,CondElseContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> VRetContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::VRetContext(
				BaseParserRuleContext::copy_from(ctx,VRetContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> ForContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::ForContext(
				BaseParserRuleContext::copy_from(ctx,ForContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> SExpContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::SExpContext(
				BaseParserRuleContext::copy_from(ctx,SExpContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> DecrContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::DecrContext(
				BaseParserRuleContext::copy_from(ctx,DecrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EmptyContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::EmptyContext(
				BaseParserRuleContext::copy_from(ctx,EmptyContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> VarDeclContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::VarDeclContext(
				BaseParserRuleContext::copy_from(ctx,VarDeclContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> IncrContextExt<'input>{
	fn new(ctx: &dyn StmtContextAttrs<'input>) -> Rc<StmtContextAll<'input>>  {
		Rc::new(
			StmtContextAll::IncrContext(
				BaseParserRuleContext::copy_from(ctx,IncrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<StmtContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 16, RULE_stmt);
...
impl<'input> CustomRuleContext<'input> for LvalContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_lval }
	//fn type_rule_index() -> usize where Self: Sized { RULE_lval }
}
antlr_rust::tid!{LvalContextExt<'a>}

impl<'input> LvalContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<LvalContextAll<'input>> {
		Rc::new(
		LvalContextAll::Error(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,LvalContextExt{
				ph:PhantomData
			}),
		)
		)
...
pub trait LvalContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<LvalContextExt<'input>>{
...
impl<'input> Borrow<LvalContextExt<'input>> for LFieldContext<'input>{
	fn borrow(&self) -> &LvalContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<LvalContextExt<'input>> for LFieldContext<'input>{
	fn borrow_mut(&mut self) -> &mut LvalContextExt<'input> { &mut self.base }
}
...
impl<'input> LFieldContextExt<'input>{
	fn new(ctx: &dyn LvalContextAttrs<'input>) -> Rc<LvalContextAll<'input>>  {
		Rc::new(
			LvalContextAll::LFieldContext(
				BaseParserRuleContext::copy_from(ctx,LFieldContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> LIDContextExt<'input>{
	fn new(ctx: &dyn LvalContextAttrs<'input>) -> Rc<LvalContextAll<'input>>  {
		Rc::new(
			LvalContextAll::LIDContext(
				BaseParserRuleContext::copy_from(ctx,LIDContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> LArrContextExt<'input>{
	fn new(ctx: &dyn LvalContextAttrs<'input>) -> Rc<LvalContextAll<'input>>  {
		Rc::new(
			LvalContextAll::LArrContext(
				BaseParserRuleContext::copy_from(ctx,LArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn  lval(&mut self,)
	-> Result<Rc<LvalContextAll<'input>>,ANTLRError> {
		self.lval_rec(0)
	}

	fn lval_rec(&mut self, _p: isize)
	-> Result<Rc<LvalContextAll<'input>>,ANTLRError> {
		let recog = self;
		let _parentctx = recog.ctx.take();
		let _parentState = recog.base.get_state();
		let mut _localctx = LvalContextExt::new(_parentctx.clone(), recog.base.get_state());
		recog.base.enter_recursion_rule(_localctx.clone(), 18, RULE_lval, _p);
				...
				if _alt==1 {
					...
					match  recog.interpreter.adaptive_predict(9,&mut recog.base)? {
						1 =>{
							...
							let mut tmp = LFieldContextExt::new(&**LvalContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_lval);
							_localctx = tmp;
					...
					,
						2 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = LArrContextExt::new(&**LvalContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_lval);
							_localctx = tmp;
...
impl<'input> Type_ContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Type_ContextAll<'input>> {
		Rc::new(
...
pub trait Type_ContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<Type_ContextExt<'input>>{
...
impl<'input> Borrow<Type_ContextExt<'input>> for StrContext<'input>{
	fn borrow(&self) -> &Type_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Type_ContextExt<'input>> for StrContext<'input>{
	fn borrow_mut(&mut self) -> &mut Type_ContextExt<'input> { &mut self.base }
}

impl<'input> Type_ContextAttrs<'input> for StrContext<'input> {}

impl<'input> StrContextExt<'input>{
	fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>>  {
		Rc::new(
			Type_ContextAll::StrContext(
...
impl<'input> Borrow<Type_ContextExt<'input>> for ArrContext<'input>{
	fn borrow(&self) -> &Type_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Type_ContextExt<'input>> for ArrContext<'input>{
	fn borrow_mut(&mut self) -> &mut Type_ContextExt<'input> { &mut self.base }
}

impl<'input> Type_ContextAttrs<'input> for ArrContext<'input> {}

impl<'input> ArrContextExt<'input>{
	fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>>  {
		Rc::new(
			Type_ContextAll::ArrContext(
				BaseParserRuleContext::copy_from(ctx,ArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> Borrow<Type_ContextExt<'input>> for BoolContext<'input>{
	fn borrow(&self) -> &Type_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Type_ContextExt<'input>> for BoolContext<'input>{
	fn borrow_mut(&mut self) -> &mut Type_ContextExt<'input> { &mut self.base }
}

impl<'input> Type_ContextAttrs<'input> for BoolContext<'input> {}

impl<'input> BoolContextExt<'input>{
	fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>>  {
		Rc::new(
			Type_ContextAll::BoolContext(
				BaseParserRuleContext::copy_from(ctx,BoolContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> Borrow<Type_ContextExt<'input>> for ClassContext<'input>{
	fn borrow(&self) -> &Type_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Type_ContextExt<'input>> for ClassContext<'input>{
	fn borrow_mut(&mut self) -> &mut Type_ContextExt<'input> { &mut self.base }
}

impl<'input> Type_ContextAttrs<'input> for ClassContext<'input> {}

impl<'input> ClassContextExt<'input>{
	fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>>  {
		Rc::new(
			Type_ContextAll::ClassContext(
				BaseParserRuleContext::copy_from(ctx,ClassContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> VoidContextExt<'input>{
	fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>>  {
		Rc::new(
			Type_ContextAll::VoidContext(
				BaseParserRuleContext::copy_from(ctx,VoidContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> Borrow<Type_ContextExt<'input>> for IntContext<'input>{
	fn borrow(&self) -> &Type_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Type_ContextExt<'input>> for IntContext<'input>{
	fn borrow_mut(&mut self) -> &mut Type_ContextExt<'input> { &mut self.base }
}

impl<'input> Type_ContextAttrs<'input> for IntContext<'input> {}

impl<'input> IntContextExt<'input>{
	fn new(ctx: &dyn Type_ContextAttrs<'input>) -> Rc<Type_ContextAll<'input>>  {
		Rc::new(
			Type_ContextAll::IntContext(
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	fn type__rec(&mut self, _p: isize)
	-> Result<Rc<Type_ContextAll<'input>>,ANTLRError> {
		let recog = self;
		let _parentctx = recog.ctx.take();
		let _parentState = recog.base.get_state();
		let mut _localctx = Type_ContextExt::new(_parentctx.clone(), recog.base.get_state());
		recog.base.enter_recursion_rule(_localctx.clone(), 20, RULE_type_, _p);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			match recog.base.input.la(1) {
			 ...
			 T__23 
				=> {
					{
					let mut tmp = VoidContextExt::new(&**_localctx);
					recog.ctx = Some(tmp.clone());
					_localctx = tmp;
					_prevctx = _localctx.clone();
			...
			while { _alt!=2 && _alt!=INVALID_ALT } {
				if _alt==1 {
					...
					{
					/*recRuleLabeledAltStartAction*/
					let mut tmp = ArrContextExt::new(&**Type_ContextExt::new(_parentctx.clone(), _parentState));
					recog.push_new_recursion_context(tmp.clone(), _startState, RULE_type_);
					_localctx = tmp;
...
//------------------- newtype_ ----------------
#[derive(Debug)]
pub enum Newtype_ContextAll<'input>{
...
Error(Newtype_Context<'input>)
}
antlr_rust::tid!{Newtype_ContextAll<'a>}

impl<'input> antlr_rust::parser_rule_context::DerefSeal for Newtype_ContextAll<'input>{}

impl<'input> LatteParserContext<'input> for Newtype_ContextAll<'input>{}

impl<'input> Deref for Newtype_ContextAll<'input>{
	type Target = dyn Newtype_ContextAttrs<'input> + 'input;
	fn deref(&self) -> &Self::Target{
		use Newtype_ContextAll::*;
		match self{
...
impl<'input,'a> Visitable<dyn LatteVisitor<'input> + 'a> for Newtype_ContextAll<'input>{
	fn accept(&self, visitor: &mut (dyn LatteVisitor<'input> + 'a)) { self.deref().accept(visitor) }
}
impl<'input,'a> Listenable<dyn LatteListener<'input> + 'a> for Newtype_ContextAll<'input>{
    fn enter(&self, listener: &mut (dyn LatteListener<'input> + 'a)) { self.deref().enter(listener) }
    fn exit(&self, listener: &mut (dyn LatteListener<'input> + 'a)) { self.deref().exit(listener) }
}
...
pub type Newtype_Context<'input> = BaseParserRuleContext<'input,Newtype_ContextExt<'input>>;

#[derive(Clone)]
pub struct Newtype_ContextExt<'input>{
ph:PhantomData<&'input str>
}

impl<'input> LatteParserContext<'input> for Newtype_Context<'input>{}

impl<'input,'a> Listenable<dyn LatteListener<'input> + 'a> for Newtype_Context<'input>{
}

impl<'input,'a> Visitable<dyn LatteVisitor<'input> + 'a> for Newtype_Context<'input>{
}

impl<'input> CustomRuleContext<'input> for Newtype_ContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = LatteParserContextType;
	fn get_rule_index(&self) -> usize { RULE_newtype_ }
	//fn type_rule_index() -> usize where Self: Sized { RULE_newtype_ }
}
antlr_rust::tid!{Newtype_ContextExt<'a>}

impl<'input> Newtype_ContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Newtype_ContextAll<'input>> {
		Rc::new(
		Newtype_ContextAll::Error(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Newtype_ContextExt{
				ph:PhantomData
			}),
		)
		)
...
pub trait Newtype_ContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<Newtype_ContextExt<'input>>{


}

impl<'input> Newtype_ContextAttrs<'input> for Newtype_Context<'input>{}
...
impl<'input> Borrow<Newtype_ContextExt<'input>> for NBoolContext<'input>{
	fn borrow(&self) -> &Newtype_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Newtype_ContextExt<'input>> for NBoolContext<'input>{
	fn borrow_mut(&mut self) -> &mut Newtype_ContextExt<'input> { &mut self.base }
}

impl<'input> Newtype_ContextAttrs<'input> for NBoolContext<'input> {}

impl<'input> NBoolContextExt<'input>{
	fn new(ctx: &dyn Newtype_ContextAttrs<'input>) -> Rc<Newtype_ContextAll<'input>>  {
		Rc::new(
			Newtype_ContextAll::NBoolContext(
				BaseParserRuleContext::copy_from(ctx,NBoolContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> Borrow<Newtype_ContextExt<'input>> for NIntContext<'input>{
	fn borrow(&self) -> &Newtype_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Newtype_ContextExt<'input>> for NIntContext<'input>{
	fn borrow_mut(&mut self) -> &mut Newtype_ContextExt<'input> { &mut self.base }
}

impl<'input> Newtype_ContextAttrs<'input> for NIntContext<'input> {}

impl<'input> NIntContextExt<'input>{
	fn new(ctx: &dyn Newtype_ContextAttrs<'input>) -> Rc<Newtype_ContextAll<'input>>  {
		Rc::new(
			Newtype_ContextAll::NIntContext(
				BaseParserRuleContext::copy_from(ctx,NIntContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> Borrow<Newtype_ContextExt<'input>> for NClassContext<'input>{
	fn borrow(&self) -> &Newtype_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Newtype_ContextExt<'input>> for NClassContext<'input>{
	fn borrow_mut(&mut self) -> &mut Newtype_ContextExt<'input> { &mut self.base }
}

impl<'input> Newtype_ContextAttrs<'input> for NClassContext<'input> {}

impl<'input> NClassContextExt<'input>{
	fn new(ctx: &dyn Newtype_ContextAttrs<'input>) -> Rc<Newtype_ContextAll<'input>>  {
		Rc::new(
			Newtype_ContextAll::NClassContext(
				BaseParserRuleContext::copy_from(ctx,NClassContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> Borrow<Newtype_ContextExt<'input>> for NStrContext<'input>{
	fn borrow(&self) -> &Newtype_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Newtype_ContextExt<'input>> for NStrContext<'input>{
	fn borrow_mut(&mut self) -> &mut Newtype_ContextExt<'input> { &mut self.base }
}

impl<'input> Newtype_ContextAttrs<'input> for NStrContext<'input> {}

impl<'input> NStrContextExt<'input>{
	fn new(ctx: &dyn Newtype_ContextAttrs<'input>) -> Rc<Newtype_ContextAll<'input>>  {
		Rc::new(
			Newtype_ContextAll::NStrContext(
				BaseParserRuleContext::copy_from(ctx,NStrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> Borrow<Newtype_ContextExt<'input>> for NArrContext<'input>{
	fn borrow(&self) -> &Newtype_ContextExt<'input> { &self.base }
}
impl<'input> BorrowMut<Newtype_ContextExt<'input>> for NArrContext<'input>{
	fn borrow_mut(&mut self) -> &mut Newtype_ContextExt<'input> { &mut self.base }
}

impl<'input> Newtype_ContextAttrs<'input> for NArrContext<'input> {}

impl<'input> NArrContextExt<'input>{
	fn new(ctx: &dyn Newtype_ContextAttrs<'input>) -> Rc<Newtype_ContextAll<'input>>  {
		Rc::new(
			Newtype_ContextAll::NArrContext(
				BaseParserRuleContext::copy_from(ctx,NArrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn newtype_(&mut self,)
	-> Result<Rc<Newtype_ContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Newtype_ContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 22, RULE_newtype_);
        let mut _localctx: Rc<Newtype_ContextAll> = _localctx;
		let result: Result<(), ANTLRError> = (|| {
...
//------------------- item ----------------
pub type ItemContextAll<'input> = ItemContext<'input>;
...
impl<'input,'a> Listenable<dyn LatteListener<'input> + 'a> for ItemContext<'input>{
		fn enter(&self,listener: &mut (dyn LatteListener<'input> + 'a)) {
			listener.enter_every_rule(self);
			listener.enter_item(self);
		}
		fn exit(&self,listener: &mut (dyn LatteListener<'input> + 'a)) {
			listener.exit_item(self);
			listener.exit_every_rule(self);
		}
}
...
impl<'input> ItemContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ItemContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ItemContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ItemContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ItemContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ItemContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ItemContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 24, RULE_item);
...
impl<'input> ExprContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ExprContextAll<'input>> {
		Rc::new(
...
pub trait ExprContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<ExprContextExt<'input>>{
...
impl<'input> EIdContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EIdContext(
				BaseParserRuleContext::copy_from(ctx,EIdContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EFunCallContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EFunCallContext(
				BaseParserRuleContext::copy_from(ctx,EFunCallContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> ERelOpContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::ERelOpContext(
				BaseParserRuleContext::copy_from(ctx,ERelOpContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> ETrueContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::ETrueContext(
				BaseParserRuleContext::copy_from(ctx,ETrueContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EOrContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EOrContext(
				BaseParserRuleContext::copy_from(ctx,EOrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
pub trait EIntContextAttrs<'input>: LatteParserContext<'input>{
	...
	fn INT(&self) -> Option<Rc<TerminalNode<'input,LatteParserContextType>>> where Self:Sized{
...
impl<'input> EIntContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EIntContext(
				BaseParserRuleContext::copy_from(ctx,EIntContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EUnOpContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EUnOpContext(
				BaseParserRuleContext::copy_from(ctx,EUnOpContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
pub trait EStrContextAttrs<'input>: LatteParserContext<'input>{
	...
	fn STR(&self) -> Option<Rc<TerminalNode<'input,LatteParserContextType>>> where Self:Sized{
...
impl<'input> EStrContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EStrContext(
				BaseParserRuleContext::copy_from(ctx,EStrContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EArrSubContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EArrSubContext(
				BaseParserRuleContext::copy_from(ctx,EArrSubContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EMulOpContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EMulOpContext(
				BaseParserRuleContext::copy_from(ctx,EMulOpContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EAndContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EAndContext(
				BaseParserRuleContext::copy_from(ctx,EAndContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EParenContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EParenContext(
				BaseParserRuleContext::copy_from(ctx,EParenContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EFalseContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EFalseContext(
				BaseParserRuleContext::copy_from(ctx,EFalseContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EMetCallContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EMetCallContext(
				BaseParserRuleContext::copy_from(ctx,EMetCallContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
pub trait ENewContextAttrs<'input>: LatteParserContext<'input>{
	fn newtype_(&self) -> Option<Rc<Newtype_ContextAll<'input>>> where Self:Sized{
		self.child_of_type(0)
	}
}
...
impl<'input> ENewContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::ENewContext(
				BaseParserRuleContext::copy_from(ctx,ENewContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EAddOpContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EAddOpContext(
				BaseParserRuleContext::copy_from(ctx,EAddOpContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> ENullContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::ENullContext(
				BaseParserRuleContext::copy_from(ctx,ENullContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
...
impl<'input> EFieldContextExt<'input>{
	fn new(ctx: &dyn ExprContextAttrs<'input>) -> Rc<ExprContextAll<'input>>  {
		Rc::new(
			ExprContextAll::EFieldContext(
				BaseParserRuleContext::copy_from(ctx,EFieldContextExt{
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
			)
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			,
				6 =>{
					...
					recog.err_handler.sync(&mut recog.base)?;
					_la = recog.base.input.la(1);
					if (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << T__2) | (1usize << T__25) | (1usize << T__26) | (1usize << T__29) | (1usize << T__30))) != 0) || ((((_la - 33)) & !0x3f) == 0 && ((1usize << (_la - 33)) & ((1usize << (T__32 - 33)) | (1usize << (INT - 33)) | (1usize << (ID - 33)) | (1usize << (STR - 33)))) != 0) {
						{
						/*InvokeRule expr*/
				...
				if _alt==1 {
					...
					match  recog.interpreter.adaptive_predict(20,&mut recog.base)? {
						1 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = EMulOpContextExt::new(&**ExprContextExt::new(_parentctx.clone(), _parentState));
					...
					,
						2 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = EAddOpContextExt::new(&**ExprContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr);
							_localctx = tmp;
					...
					,
						3 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = ERelOpContextExt::new(&**ExprContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr);
							_localctx = tmp;
					...
					,
						4 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = EAndContextExt::new(&**ExprContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr);
							_localctx = tmp;
					...
					,
						5 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = EOrContextExt::new(&**ExprContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr);
							_localctx = tmp;
					...
					,
						6 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = EArrSubContextExt::new(&**ExprContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr);
							_localctx = tmp;
					...
					,
						7 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = EFieldContextExt::new(&**ExprContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr);
							_localctx = tmp;
					...
					,
						8 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = EMetCallContextExt::new(&**ExprContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expr);
							_localctx = tmp;
...
impl<'input> AddOpContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AddOpContextAll<'input>> {
		Rc::new(
...
pub trait AddOpContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<AddOpContextExt<'input>>{
...
impl<'input> MulOpContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<MulOpContextAll<'input>> {
		Rc::new(
...
pub trait MulOpContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<MulOpContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<MulOpContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 35)) & !0x3f) == 0 && ((1usize << (_la - 35)) & ((1usize << (T__34 - 35)) | (1usize << (T__35 - 35)) | (1usize << (T__36 - 35)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input> RelOpContextExt<'input>{
	fn new(parent: Option<Rc<dyn LatteParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<RelOpContextAll<'input>> {
		Rc::new(
...
pub trait RelOpContextAttrs<'input>: LatteParserContext<'input> + BorrowMut<RelOpContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<RelOpContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 32, RULE_relOp);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 38)) & !0x3f) == 0 && ((1usize << (_la - 38)) & ((1usize << (T__37 - 38)) | (1usize << (T__38 - 38)) | (1usize << (T__39 - 38)) | (1usize << (T__40 - 38)) | (1usize << (T__41 - 38)) | (1usize << (T__42 - 38)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;