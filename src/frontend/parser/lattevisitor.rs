...
pub trait LatteVisitor<'input>: ParseTreeVisitor<'input,LatteParserContextType>{
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_TopFnDef(&mut self, ctx: &TopFnDefContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_items(&mut self, ctx: &ItemsContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_DeclItemUninit(&mut self, ctx: &DeclItemUninitContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_DeclItemInit(&mut self, ctx: &DeclItemInitContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_Nonvoid(&mut self, ctx: &NonvoidContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_IntArr(&mut self, ctx: &IntArrContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_StrArr(&mut self, ctx: &StrArrContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_BooleanArr(&mut self, ctx: &BooleanArrContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_ClassArr(&mut self, ctx: &ClassArrContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_NIntArr(&mut self, ctx: &NIntArrContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_NStrArr(&mut self, ctx: &NStrArrContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_NBooleanArr(&mut self, ctx: &NBooleanArrContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_NClassArr(&mut self, ctx: &NClassArrContext<'input>) { self.visit_children(ctx) }
